...
class QueueTest extends AnyFlatSpec with Matchers{
  ...
  "AlgoAndDataStructure Queue: peekFront() with queue of 3" should "returns 8" in {
    val queue: QueueStructure = new QueueStructure(3)
    queue.insert(9)
    queue.insert(8)
    queue.insert(7)
    ...
    array(1) = 8
    array(2) = 7
    val expected:Any = array(1)
    assert(expected === actual)
  }

  "AlgoAndDataStructure Queue: peekFront() with queue of 3" should "returns 7" in {
    val queue: QueueStructure = new QueueStructure(3)
    queue.insert(9)
    queue.insert(8)
    queue.insert(7)
    ...
    array(1) = null
    array(2) = 7
    val expected:Any = array(2)
    assert(expected === actual)
  }

  "AlgoAndDataStructure Queue: peekFront() with queue of 3" should "returns null" in {
    val queue: QueueStructure = new QueueStructure(3)
    queue.insert(9)
    queue.insert(8)
    queue.insert(7)
  ...
  "AlgoAndDataStructure Queue: peekFront() with queue of 3" should "returns 10" in {
    val queue: QueueStructure = new QueueStructure(3)
    queue.insert(9)
    queue.insert(8)
    queue.insert(7)
  ...
  "AlgoAndDataStructure Queue: isEmpty() with emptyQueue" should "returns True" in {
    val queue: QueueStructure = new QueueStructure(3)
    val actual: Boolean = queue.isEmpty()
    val expected: Boolean = true
    assert(expected == actual)
  }

  "AlgoAndDataStructure Queue: isEmpty() with queue(1)" should "returns false" in {
    val queue: QueueStructure = new QueueStructure(3)
    queue.insert(1)
    val actual: Boolean = queue.isEmpty()
  ...
  "AlgoAndDataStructure Queue: isEmpty() with queue(1) with remove" should "returns true" in {
    val queue: QueueStructure = new QueueStructure(3)
    queue.insert(1)
    queue.remove()
    val actual: Boolean = queue.isEmpty()
  ...
  "AlgoAndDataStructure Queue: isEmpty() with queue(1,1,1)" should "returns false" in {
    val queue: QueueStructure = new QueueStructure(3)
    queue.insert(1)
    queue.insert(1)
    queue.insert(1)
  ...
  "AlgoAndDataStructure Queue: emptyQueue.isFull()" should "returns false" in {
    val queue: QueueStructure = new QueueStructure(3)
  ...
  "AlgoAndDataStructure Queue: fullQueue.isFull()" should "returns true" in {
    val queue: QueueStructure = new QueueStructure(3)
    queue.insert(1)
    queue.insert(1)
    queue.insert(1)
  ...
  "AlgoAndDataStructure Queue: removeQueue.isFull()" should "returns false" in {
    val queue: QueueStructure = new QueueStructure(3)
    queue.insert(1)
    queue.insert(1)
    queue.insert(1)
