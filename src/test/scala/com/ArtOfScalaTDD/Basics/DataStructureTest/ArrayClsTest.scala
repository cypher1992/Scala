...
class ArrayClsTest extends AnyFlatSpec with Matchers{
  ...
  "ArtOfScala ArrayCls: array.partionX(lessThan10)" should "Second Tuple return Array(10)" in {
    val array: Array[Int] = Array(1,10)
    val arr: ArrayCLS[Int] = new ArrayCLS(array)
    def lessThan10(int: Int):Boolean = if(int< 10) true else false
    val actual: Array[Int] = arr.partionX(lessThan10)._2
  ...
  "ArtOfScala ArrayCls: array.filterX(filterChar)" should "return Array.empty[Char]" in {
    val array: Array[Char] = Array.empty[Char]
    val arr: ArrayCLS[Char] = new ArrayCLS(array)
    def filterChar(char:Char,targetChar:Char):Boolean = if(char == targetChar) true else false
    val actual: Array[Char] = arr.filterX(filterChar(_,'A'))
    val expected: Array[Char] = Array.empty[Char]
    assert(actual === expected)
  }

  "ArtOfScala ArrayCls: array.filterX(filterChar)" should "return Array('A')" in {
    val array: Array[Char] = Array('B','A','C')
    val arr: ArrayCLS[Char] = new ArrayCLS(array)
    def filterChar(char:Char,targetChar:Char):Boolean = if(char == targetChar) true else false
    val actual: Array[Char] = arr.filterX(filterChar(_,'A'))
    val expected: Array[Char] = Array('A')
    assert(actual === expected)
  }

  "ArtOfScala ArrayCls: array.filterX(lessThan2)" should "return Array(1,2)" in {
    val array: Array[Int] = Array(1,2,3)
    val arr: ArrayCLS[Int] = new ArrayCLS(array)
    def lessThan2(num:Int,targetNum:Int):Boolean = if(num < targetNum) true else false
    val actual: Array[Int] = arr.filterX(lessThan2(_,3))
    val expected: Array[Int] = Array(1,2)
    assert(actual === expected)
  }

  "ArtOfScala ArrayCls: array.filterX(lessThan3OrEqual)" should "return Array(1,2,3)" in {
    val array: Array[Int] = Array(1,2,3,4)
    val arr: ArrayCLS[Int] = new ArrayCLS(array)
    def lessThan3OrEqual(num:Int,targetNum:Int):Boolean = if(num <= targetNum) true else false
    val actual: Array[Int] = arr.filterX(lessThan3OrEqual(_,3))
    val expected: Array[Int] = Array(1,2,3)
    assert(actual === expected)
  }
  ...
  "ArtOfScala ArrayCls: array.notFilterX(lessThan2)" should "return Array(3)" in {
    val array: Array[Int] = Array(1,2,3)
    val arr: ArrayCLS[Int] = new ArrayCLS(array)
    def lessThan2(num:Int,targetNum:Int):Boolean = if(num < targetNum) true else false
    val actual: Array[Int] = arr.notFilterX(lessThan2(_,3))
    val expected: Array[Int] = Array(3)
    assert(actual === expected)
  }

  "ArtOfScala ArrayCls: array.notFilterX(lessThan3OrEqual)" should "return Array(4)" in {
    val array: Array[Int] = Array(1,2,3,4)
    val arr: ArrayCLS[Int] = new ArrayCLS(array)
    def lessThan3OrEqual(num:Int,targetNum:Int):Boolean = if(num <= targetNum) true else false
    val actual: Array[Int] = arr.notFilterX(lessThan3OrEqual(_,3))
  ...
  "ArtOfScala ArrayCls: array.notFilterX(!lessThan3OrEqual)" should "return Array(1,2,3)" in {
    val array: Array[Int] = Array(1,2,3,4)
    val arr: ArrayCLS[Int] = new ArrayCLS(array)
    def lessThan3OrEqual(num:Int,targetNum:Int):Boolean = if(num <= targetNum) true else false
    val actual: Array[Int] = arr.notFilterX(!lessThan3OrEqual(_,3))
  ...
  "ArtOfScala ArrayCls: array.foldLeftX(0)(_+_.size)" should "return total string size 0" in {
    val array: Array[String] = Array.empty[String]
    val arr: ArrayCLS[String] = new ArrayCLS(array)
    val actual: Int = arr.foldLeftX(0)(_ + _.size)
    val expected: Int = 0
    assert(actual === expected)
  }

  "ArtOfScala ArrayCls: array.foldLeftX(0)(_+_.size)" should "return total string size 7" in {
    val array: Array[String] = Array("Waffles")
    val arr: ArrayCLS[String] = new ArrayCLS(array)
    val actual: Int = arr.foldLeftX(0)(_ + _.size)
    val expected: Int = 7
    assert(actual === expected)
  ...
  "ArtOfScala ArrayCls: array.foldLeftX(0)(_+_.size)" should "return total string size 6" in {
    val array: Array[String] = Array("Waffles" , "Cajun French Fries")
    val arr: ArrayCLS[String] = new ArrayCLS(array)
    val actual: Int = arr.foldLeftX(0)(_ + _.size)
    val expected: Int = 25
    assert(actual === expected)
  ...
  "ArtOfScala ArrayCls: array.foldLeftX(emptyString)(_+_)" should "return total string ''" in {
    val array: Array[String] = Array.empty[String]
    val arr: ArrayCLS[String] = new ArrayCLS(array)
  ...
  "ArtOfScala ArrayCls: array.foldLeftX(emptyString)(_+_)" should "return total string 'Hello World '" in {
    val array: Array[String] = Array("Hello", "World")
    val arr: ArrayCLS[String] = new ArrayCLS(array)
    val actual: String = arr.foldLeftX("")(_ + _ + " ")
  ...
  "ArtOfScala ArrayCls: array.foldLeftX(emptyString)(_+_)" should "return total string 'Hello World to Robert '" in {
    val array: Array[String] = Array("Hello", "World", "to", "Robert")
    val arr: ArrayCLS[String] = new ArrayCLS(array)
    val actual: String = arr.foldLeftX("")(_ + _ + " ")
  ...
  "ArtOfScala ArrayCls: array.combinationX(0)" should "return empty combination" in {
    val array: Array[Int] = Array.empty[Int]
    val arr: ArrayCLS[Int] = new ArrayCLS(array)
    val actual: String = arr.combinationX(0).toString()
    val expected: String = Iterator.empty[Array[Int]].toString()
    assert(actual === expected)
  }
  ...
  "ArtOfScala ArrayCls: emptyarray.combinationX(1)" should "return empty combination" in {
    val array: Array[Int] = Array.empty[Int]
    val arr: ArrayCLS[Int] = new ArrayCLS(array)
  ...
  "ArtOfScala ArrayCls: emptyarray.combinationX(2)" should "return empty combination" in {
    val array: Array[Int] = Array.empty[Int]
    val arr: ArrayCLS[Int] = new ArrayCLS(array)
    val iteratorArray: Iterator[Array[Int]] = arr.combinationX(2)
    var actual:List[String] = List.empty[String]
    for( i <- iteratorArray){
      actual = actual.appended(i.mkString)
    }
  ...
  "ArtOfScala ArrayCls: array.combinationX(1)" should "return combination" in {
  ...
  "ArtOfScala ArrayCls: array.combinationX(2)" should "return combination(10,12,02)" in {
    ...
    println(actual)
    val expected: List[String] = List("10","12","02")
    assert(actual === expected)
  }
  ...
  "ArtOfScala ArrayCls: array.permutationX()" should "return empty permutation" in {
    val array: Array[Int] = Array.empty[Int]
    val arr: ArrayCLS[Int] = new ArrayCLS(array)
  ...
  "ArtOfScala ArrayCls: array.permutationX()" should "return permutation (1)" in {
    val array: Array[Int] = Array(1)
    val arr: ArrayCLS[Int] = new ArrayCLS(array)
    val iteratorArray: Iterator[Array[Int]] = arr.permutationX()
    var actual:List[String] = List.empty[String]
  ...
  "ArtOfScala ArrayCls: array.permutationX()" should "return permutation (0,1(1,0)" in {
    ...
    println(actual)
    val expected: List[String] = List("01","10")
    assert(actual === expected)
  }

  "ArtOfScala ArrayCls: array.permutationX()" should "return permutation (0,0,1)(0,1,0)(1,0,0)" in {
    val array: Array[Int] = Array(0,1,0)
    val arr: ArrayCLS[Int] = new ArrayCLS(array)
    val iteratorArray: Iterator[Array[Int]] = arr.permutationX()
    var actual:List[String] = List.empty[String]
    for( i <- iteratorArray){
    ...
    println(actual)
    val expected: List[String] = List("001","010","100")
    assert(actual === expected)
  }

  "ArtOfScala ArrayCls: array.permutationX()" should "return permutation (0,0,0)" in {
    ...
    println(actual)
    val expected: List[String] = List("000")
    assert(actual === expected)
  }

  "ArtOfScala ArrayCls: array.permutationX()" should "return permutation (012, 021, 102, 120, 201, 210)" in {
    ...
    println(actual)
    val expected: List[String] = List("012", "021", "102", "120", "201", "210")
    assert(actual === expected)
  }

  "ArtOfScala ArrayCls: emptyArray.groupedX(0)" should "return empty groups ()" in {
    val array: Array[Int] = Array.empty[Int]
    val arr: ArrayCLS[Int] = new ArrayCLS(array)
    val iteratorArray: Iterator[Array[Int]] = arr.groupedX(0)
    var actual:List[String] = List.empty[String]
    for( i <- iteratorArray){
      actual = actual.appended(i.mkString)
    }
  ...
  "ArtOfScala ArrayCls: emptyArray.groupedX(1)" should "return empty groups ()" in {
    val array: Array[Int] = Array.empty[Int]
    val arr: ArrayCLS[Int] = new ArrayCLS(array)
